...
// Left
#define PIN_DPAD_DOWN   6           // DOWN
#define PIN_DPAD_RIGHT  7           // RIGHT
#define PIN_DPAD_LEFT   8           // LEFT
#define PIN_DPAD_UP     9           // UP

#define PIN_BUTTON_A1   2          // A1 / Guide / Home / PS / 13 / ~
#define PIN_BUTTON_A2   3          // A2 / ~ / Capture / ~ / 14 / ~

// Right
#define PIN_BUTTON_S1   4          // S1 / Back / Minus / Select / 9 / Coin
#define PIN_BUTTON_S2   5          // S2 / Start / Plus / Start / 10 / Start

#define PIN_BUTTON_B1   10           // B1 / A / B / Cross / 2 / K1
#define PIN_BUTTON_B2   11           // B2 / B / A / Circle / 3 / K2
#define PIN_BUTTON_L1   12          // L1 / LB / L / L1 / 5 / P4
#define PIN_BUTTON_R1   13          // R1 / RB / R / R1 / 6 / P3

#define PIN_BUTTON_B3   21          // B3 / X / Y / Square / 1 / P1
#define PIN_BUTTON_B4   20          // B4 / Y / X / Triangle / 4 / P2
#define PIN_BUTTON_R2   19           // R2 / RT / ZR / R2 / 8 / K3
#define PIN_BUTTON_L2   18           // L2 / LT / ZL / L2 / 7 / K4
